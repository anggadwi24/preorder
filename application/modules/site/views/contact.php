                  ...
                  <ul>
                    <li>
                      <div class="contact-thumb">
                        <img src="<?= base_url('') ?>/assets/images/address-icon.svg" alt="xpoge">
                      </div>
                    ...
                    <li>
                      <div class="contact-thumb">
                        <img src="<?= base_url('') ?>/assets/images/mail-icon.svg" alt="xpoge">
                      </div>
                      <div class="contact-box-detail">
                    ...
                    <li>
                      <div class="contact-thumb">
                        <img src="<?= base_url('') ?>/assets/images/phone-icon.svg" alt="xpoge">
                      </div>
                      <div class="contact-box-detail">
