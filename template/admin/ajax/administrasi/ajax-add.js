...
$(document).on('change','#country',function(){
    ...
    if(val == 'Indonesia'){
        ...
        var province = '<label>Provinsi</label><input type="text" name="province"  class="form-control">';
        var kabupaten = '<label>Kabupaten</label><input type="text" name="kabupaten" class="form-control">';
        var kecamatan = '<label>Kecamatan</label><input type="text" name="kecamatan"  class="form-control">';
        var kelurahan = '<label>Kelurahan</label><input type="text" name="kelurahan"  class="form-control">';
